  ...
  return (
    <AppShell>
      <div style={{ minHeight: '100vh', background: '#F7F6F4' }}>
        {/* Hero Section */}
        <section style={{ borderBottom: '1px solid #E5E4E0', padding: '5rem 2rem lg:5rem 2rem', background: '#F7F6F4' }}>
            ...
            >
              ...
              <div style={{ marginTop: '1.5rem' }}>
                <div className="inline-flex items-center gap-2" style={{ color: '#1A1A1A' }}>
                  ...
                  <span style={{ fontWeight: 600, fontSize: '1rem' }}>No sugarcoating. No false promises. Just reality.</span>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section style={{ borderBottom: '1px solid #E5E4E0', padding: '5rem 2rem lg:5rem 2rem', background: '#FFFFFF' }}>
          <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p style={{ color: '#1A1A1A', marginBottom: '0.5rem', lineHeight: 1.5, fontSize: '1rem' }}>
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p style={{ color: '#1A1A1A', lineHeight: 1.5, fontSize: '1rem' }}>
                ...
                >
                  ...
                  <ul style={{ marginLeft: '1.5rem', marginTop: '0.75rem' }}>
                    {stage.bullets.map((bullet, i) => (
                      <li key={i} style={{ fontSize: '0.875rem', color: '#717171', marginBottom: '0.25rem', listStyle: 'disc', lineHeight: 1.5 }}>
                        {bullet}
                      </li>
                    ))}
                  </ul>
        ...
        {/* Final CTA */}
        <section style={{ padding: '5rem 2rem lg:5rem 2rem', background: '#F7F6F4', borderTop: '1px solid #E5E4E0' }}>
          <div className="max-w-2xl mx-auto text-center">
            <h2 style={{ fontSize: '1.875rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '1rem' }}>
              Ready to Get Started?
            </h2>
            <p style={{ fontSize: '1rem', color: '#717171', marginBottom: '2rem', lineHeight: 1.5 }}>
