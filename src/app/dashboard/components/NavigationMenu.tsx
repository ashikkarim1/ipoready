...
const LISTED_SERVICES_SECTIONS = [
  ...
  },
  {
    ...
    label: 'Board Intelligence Portal',
    icon: Users,
    tier: 'professional',
    badge: 'blue',
    color: 'blue',
  },
  {
    ...
    label: 'Advisor Orchestration Network',
    icon: Network,
    tier: 'enterprise',
    badge: 'red',
    color: 'red',
  ...
  {
    href: '/dashboard/post-ipo-compliance',
    label: 'Post-IPO Compliance Module',
    icon: CheckSquare,
    tier: 'enterprise',
    badge: 'purple',
    color: 'purple',
