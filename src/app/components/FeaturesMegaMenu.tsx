  ...
  return (
    <nav className={`flex items-center flex-1 flex-wrap md:flex-nowrap gap-1 ${isSticky ? 'relative z-40' : ''}`} style={{ marginLeft: isSticky ? '1rem' : '2rem', position: 'relative', zIndex: 40 }}>
      ...
      <div className="flex items-center gap-0.5 flex-wrap md:gap-1 md:flex-nowrap" style={{ flex: 1 }}>
        ...
        <Link href="/prospectus-builder" className="hidden sm:flex items-center gap-1 px-2 md:px-3 py-1 md:py-1.5 rounded-lg text-xs md:text-sm font-medium text-nav hover:bg-gray-100 transition-colors whitespace-nowrap">
          <BookOpen className="w-3 h-3 md:w-4 md:h-4" />
          <span className="hidden md:inline">Prospectus Builder</span>
        </Link>

        {/* Resources Link */}
        <Link href="/resources" className="hidden sm:block px-2 md:px-3 py-1 md:py-1.5 rounded-lg text-xs md:text-sm font-medium text-nav hover:bg-gray-100 transition-colors whitespace-nowrap">
          Resources
        </Link>

        {/* Pricing Link */}
        <Link href="/pricing" className="px-2 md:px-3 py-1 md:py-1.5 rounded-lg text-xs md:text-sm font-medium text-nav hover:bg-gray-100 transition-colors whitespace-nowrap">
          Pricing
        </Link>
      </div>
