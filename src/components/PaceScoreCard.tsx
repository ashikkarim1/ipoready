  ...
  return (
    <div className={`rounded-lg p-6 border border-gray-200 ${getScoreBgColor()}`}>
      <div className="flex items-start justify-between gap-4 mb-4">
        <div>
          <p className="body-sm text-gray-600 mb-2">PACE Readiness Score</p>
        ...
        <div className="text-right">
          ...
          <p className="caption-sm text-gray-600 mt-1">Predicted change</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div>
          <p className="caption-sm text-gray-600 mb-1">Peer Percentile</p>
          <p className="h4 font-semibold text-gray-900">
            Top {Math.round(100 - peerPercentile)}%
          </p>
          <p className="caption-sm text-gray-600">for TSX companies</p>
        </div>

        <div>
          <p className="caption-sm text-gray-600 mb-1">Confidence</p>
      ...
      <div className="border-t border-gray-200 pt-4">
        <p className="label-sm font-semibold text-gray-700 mb-3">Key Readiness Factors</p>
        <div className="grid grid-cols-3 gap-3 body-sm">
          <div>
            <p className="caption-sm text-gray-600">Cash Runway</p>
            <p className="font-semibold">💰 {Math.round(readinessFactors.cashRunway)} mo</p>
          </div>
          <div>
            <p className="caption-sm text-gray-600">Team Hiring</p>
            <p className="font-semibold">{Math.round(readinessFactors.teamHiringProgress)}%</p>
          </div>
          <div>
            <p className="caption-sm text-gray-600">Auditor</p>
