      ...
      items: [
        {
          ...
          href: '/dashboard/investor-readiness/data-room/executive-summary',
          icon: FileText,
          description: 'Company overview and investment highlights',
        },
        {
          label: 'Financial Statements',
          href: '/dashboard/investor-readiness/data-room/financial-statements',
          icon: BarChart3,
          description: 'Audited financials and performance metrics',
        },
        {
          label: 'Legal Documents',
          href: '/dashboard/investor-readiness/data-room/legal-documents',
          icon: FileCheck,
          description: 'Articles, bylaws, and corporate documents',
        },
        {
          label: 'Regulatory Filings',
          href: '/dashboard/investor-readiness/data-room/regulatory-filings',
          icon: Shield,
          description: 'SEC filings, compliance certifications, and approvals',
        },
      ],
    },
    {
